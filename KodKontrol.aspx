<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KodKontrol.aspx.cs" Inherits="YukseklisansProje.KodKontrol" %>
            ...
            <section class="signup ">
                <div class="container border border-1 rounded rounded-3 shadow-lg">
                    <div class="signup-content">
                        ...
                        <h2 class="form-title">Kod Kontrolü</h2>
                        <div class="form-group">

                            <asp:TextBox class="form-input" ID="tbxKod" placeholder="Kod" runat="server"></asp:TextBox>
                        </div>
