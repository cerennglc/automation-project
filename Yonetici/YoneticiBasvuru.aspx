<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetici/Yonetici.Master" AutoEventWireup="true" CodeBehind="YoneticiBasvuru.aspx.cs" Inherits="YukseklisansProje.Yonetici.YoneticiBasvuru" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container rounded rounded-2 shadow py-5 my-5">
        <div class="form-group col-6">
            ...
            <asp:DropDownList ID="dropdownProgram" AppendDataBoundItems="true" AutoPostBack="true" OnSelectedIndexChanged="dropdownProgram_SelectedIndexChanged" class="form-control" runat="server">
        ...
        <div class="container border border-2 rounded rounded-2 shadow-lg mt-3 mb-3 pt-3">
            <div class="table-responsive">
                <h4 class="text-center">BAŞVURULAR</h4>
